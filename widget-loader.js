(function() {
  ...
  // Load Outfit font for toggle button
  ...
  style.textContent = [
    ...
    '  box-shadow:0 4px 20px rgba(26,26,46,0.4), 0 1px 0 rgba(214,51,108,0.2) inset;',
    ...
    '  box-shadow:0 8px 28px rgba(26,26,46,0.5), 0 1px 0 rgba(214,51,108,0.3) inset;',
    '}',
    '#zt-toggle svg { width:18px; height:18px; flex-shrink:0; }',
    '#zt-toggle .zt-icon-chat { fill:#d6336c; }',
    '#zt-toggle .zt-icon-close { fill:#e8457a; display:none; }',
